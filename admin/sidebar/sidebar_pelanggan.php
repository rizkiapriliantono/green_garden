...
<li class="nav-item">
    ...
    <div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="video_produk.php">Video Produk</a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="laporan_transaksi_pertanggal.php">Laporan Transaksi <br> (PerTanggal)</a>
            <a class="collapse-item" href="laporan_pembelian.php">Laporan Transaksi Total</a>
        </div>
    </div>
</li>
