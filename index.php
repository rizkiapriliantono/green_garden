    ...
    <main>
      ...
      <section class="home-section home-parallax home-fade home-full-height" id="home">
        <div class="hero-slider">
          <ul class="slides">
            <li class="bg-dark-30 bg-dark" style="background-image:url(assets/images/tanaman/index2.png);">
              <div class="titan-caption">
                <div class="caption-content">
                  <div class="font-alt mb-30 titan-title-size-1">Selamat Datang, <br> di toko kami</div>
                  <div class="font-alt mb-40 titan-title-size-4">Green Garden</div><a class="section-scroll btn btn-border-w btn-round" href="about.php">Lihat Detail</a>
                </div>
              </div>
            </li>
            <li class="bg-dark-30 bg-dark" style="background-image:url(assets/images/tanaman/index3.png);">
              <div class="titan-caption">
                <div class="caption-content">
                  <div class="font-alt mb-30 titan-title-size-2">Green Garden adalah sebuah website yang menyediakan informasi seputar tanaman dan <br> juga penjualan berbagai macam tanaman.</div>
                  <a class="btn btn-border-w btn-round" href="about.php">Informasi Tanaman</a>
                </div>
              </div>
            </li>
            <li class="bg-dark-30 bg-dark" style="background-image:url(assets/images/tanaman/index4.png);">
              <div class="titan-caption">
                <div class="caption-content">
                  <div class="font-alt mb-30 titan-title-size-1">Kami menyediakan beberapa tanaman yang dijual</div>
