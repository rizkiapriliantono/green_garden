            ...
            <?php if (mysqli_num_rows($kat)){?>
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="shop-item">
                  ...
                  <div class="shop-item-detail"><a href="detail.php?id=<?php echo $value["id_produk"];?>" class="btn btn-round btn-b"><i class="fas fa-info-circle"></i> Detail</a></div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 mb-50">
                        <div class="footer-widget">
                            ...
                            <div class="subscribe-form" id="subscribe">
                                <form action="subscribe/subscribe_kategori.php?kategori=<?= $_GET['kategori'];?>" method="POST">
