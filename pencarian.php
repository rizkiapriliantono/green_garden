...
$semuadata = array();
$ambil = $koneksi1->query("SELECT * FROM produk WHERE nama_produk LIKE '%$keyword%' OR kat_produk LIKE '%$keyword%'");
          ...
          <div class="container">
            ...
            <?php foreach($semuadata as $key => $value):?>
                <div class="col-sm-6 col-md-4 col-lg-4">
                    ...
                    <div class="shop-item-detail"><a href="detail.php?id=<?php echo $value["id_produk"];?>" class="btn btn-round btn-b"><span class="icon-basket"> Detail</span></a></div>
                    <div class="shop-item-info"><a href="beli.php?id=<?php echo $value['id_produk']; ?>" class="btn btn-round btn-b"><span class="icon-basket"> Beli</span></a></div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 mb-50">
                        <div class="footer-widget">
                            ...
                            <div class="subscribe-form" id="subscribe">
                                <form action="subscribe/subscribe_pencarian.php?keyword=<?= $_GET['keyword'];?>" method="POST">
            ...
            <div class="container">
                ...
                <div class="col-xl-6 col-lg-6 text-center text-lg-left">
                    ...
                    <div class="footer-social-icon">
                        ...
                        <a href="https://api.whatsapp.com/send?phone=628965654408&text=Halo Mimin, Mau tanya dong ?7"><i class="fab fa-whatsapp whatsapp-bg"></i></a>
                    </div>
                    </div>
                </div>
            </div>
