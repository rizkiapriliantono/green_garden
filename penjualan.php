...
?>
          <div class="container">
            <div class="row multi-columns-row">
              <?php $ambil = $koneksi1->query("SELECT * FROM produk WHERE kat_produk IN ('tanaman','hias','umum') AND stok_produk > 1");?>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 mb-50">
                        ...
                        <div class="footer-widget-heading">
                            ...
                            <div class="subscribe-form" id="subscribe">
                                <form action="subscribe/subscribe_penjualan.php" method="POST">
