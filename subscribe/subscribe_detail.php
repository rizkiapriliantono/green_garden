...
$data = array();
$ambil_vd = $koneksi1->query("SELECT * FROM video WHERE id_produk='$id_produk'");
while ($dvd = $ambil_vd->fetch_assoc()){
  $data[] = $dvd;
}

// query ambil data Foto
...
<script>
    function salah(){
        ...
        setTimeout(function(){ 
          ...
          window.location.href = "http://localhost/green_garden/detail.php?id=<?php echo $_GET["id"];?>";
      ...
      <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#custom-collapse"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="navbar-brand" href="index.html">Green Garden</a>
          </div>
                  ...
                  <div class="row mb-20">
                    <div class="col-sm-12">
                      <ul class="nav nav-tabs font-alt" role="tablist">
                        <li class="active"><a href="#description" data-toggle="tab"><span class="icon-document"></span> Description</a></li>
                        <li><a href="#data-sheet" data-toggle="tab"><span class="icon-tools-2"></span>Cara Merawat</a></li>
                        <li><a href="#reviews" data-toggle="tab"><span class="icon-tools-2"></span>Video</a></li>
                      </ul>
                      <div class="tab-content">
                      <div class="tab-pane active description font-description" id="description">
                        ...
                        <div class="product_meta font-detail">
                          <font size="1px">Categories:<a href="kategori.php?kategori=<?= $detail['kat_produk'];?>"> <?= $detail['kat_produk'];?></a></font>
                        </div>
                      </div>
                      <div class="tab-pane" id="data-sheet">
                        <table class="table table-striped ds-table table-responsive">
                          ...
                          <?php foreach ($data as $key => $value):?>
                            ...
                            <tr>
                              <td>Cara penyiraman</td>
                              <td><?php echo $value["penyiraman"]; ?></td>
                            </tr>
                            <tr>
                              <td>Waktu Penyinaran</td>
                              <td><?php echo $value["penyinaran"]; ?></td>
                            </tr>
                            <tr>
                              <td>Pencampuran Tanah</td>
                              <td><?php echo $value["campuran_tanah"]; ?></td>
                            </tr>
                            <tr>
                              <td>Pupuk</td>
                      ...
                      <div class="tab-pane" id="reviews">
                        <div class="comments reviews">
                              <iframe width="560" height="315" src="<?php echo $value['nama']; ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            <?php endforeach?>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 mb-50">
                        <div class="footer-widget">
                            ...
                            <div class="subscribe-form" id="subscribe">
                                <form action="subscribe/subscribe_detail.php?id=<?= $_GET["id"];?>" method="POST">
