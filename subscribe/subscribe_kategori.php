...
<script>
    function salah(){
        ...
        setTimeout(function(){ 
          ...
          window.location.href = "http://localhost/green_garden/kategori.php?kategori=<?php echo $_GET['kategori'];?>#subscribe";
  ...
  <script>
    function benar(){
        ...
        setTimeout(function(){ 
          ...
          window.location.href = "http://localhost/green_garden/kategori.php?kategori=<?php echo $_GET['kategori'];?>";
