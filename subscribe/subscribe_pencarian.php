...
<script>
    function salah(){
        ...
        setTimeout(function(){ 
          ...
          window.location.href = "http://localhost/green_garden/pencarian.php?keyword=<?php echo $_GET['keyword'];?>";
          ...
          <div class="container">
            ...
            <?php foreach($semuadata as $key => $value):?>
                <div class="col-sm-6 col-md-4 col-lg-4">
                    ...
                    <div class="shop-item-detail"><a href="detail.php?id=<?php echo $perproduk["id_produk"];?>" class="btn btn-round btn-b"><span class="icon-basket"> Detail</span></a></div>
